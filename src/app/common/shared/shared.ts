...
export class Column implements AfterContentInit {
    ...
    @Input() footerComponent: Type<any>;
    @Input() cellComponent: Type<any>;
    @Input() filterComponent: Type<any>;
    @Input() cellEditor: Type<any>;
...
@Component({
    selector: 'dt-columnBodyTemplateLoader',
    template: ``
})
...
@Component({
    selector: 'dt-columnHeaderTemplateLoader',
    template: ``
})
...
@Component({
    selector: 'dt-columnFooterTemplateLoader',
    template: ``
})
...
@Component({
    selector: 'dt-columnFilterTemplateLoader',
    template: ``
})
...
@Component({
    selector: 'dt-columnEditorTemplateLoader',
    template: ``
})
